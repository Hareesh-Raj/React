      ...
      <div className="footer">
        ...
        {canDisplay && (
          <div className="success-banner">
            <p>
              Thank you <strong>{formData.name}</strong> for expressing your
              interest in travelling with us.Our sales team will get back with
              the best packages from <strong>{formData.hometown}</strong> to{" "}
